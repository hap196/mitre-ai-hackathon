...
print("Scaler loaded from 'scaler_rf.pkl'.")
...
if 'best_rf_model' in locals():
    ...
    final_predictions = pd.DataFrame(
        {
            "id": merged_data["id"],
            "phishy_pred": predictions,
        }
    )
    
    final_predictions.to_csv("final_predictions_rf.csv", index=False)
    print("Final predictions saved to 'final_predictions_rf.csv'.")
else:
